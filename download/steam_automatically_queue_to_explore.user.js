...
(function() {
    ...
    const navEl = document.querySelector("#header_wallet_ctn")
    navEl.innerHTML = '<span id="ksdl" style="cursor: pointer;">探索队列</span>' + navEl.innerHTML
    document.getElementById("ksdl").addEventListener('click',ksdl);
